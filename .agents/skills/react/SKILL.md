...
- Always check components from `src/components/ui/*` and use them if applicable.
...
- Project includes react compiler, so you don't need to use `useMemo` and `useCallback`
